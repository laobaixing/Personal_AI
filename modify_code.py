...
class GraphState(BaseModel):
    ...
    feedback: str = ""  # Human feedback on plan steps
...
def human_feedback_node(state: GraphState) -> dict:
    ...
    feedback = input("Are these steps acceptable? (yes/no): ").strip().lower()
    state.feedback = feedback
    return {"feedback": feedback}


# Router function after human feedback.
def feedback_router(state: GraphState):
...
graph.add_edge("plan_steps_node", "human_feedback_node")
